...
import { PREVIEW_INSPECTION_TOOL, requestsVisibilityInteraction, requestsBehaviorPreservation, boundVisibilityInspection, boundStaticPreviewInspection,
  ...
  visibilityInspectionInstruction } from './preview-interaction-assurance.mjs';
...
import { extractRequestedLiterals, requestedTextCheck, requestedTextInstruction, requestedTextRevisionInstruction,
  requestedTextDeliveryNote, extractRequestedControlNames, requestedControlSources, requestedControlNameCheck,
  requestedControlNameInstruction, requestedControlNameRevisionInstruction, requestedControlNameInspectionInstruction }
  from './requested-literals.mjs';
