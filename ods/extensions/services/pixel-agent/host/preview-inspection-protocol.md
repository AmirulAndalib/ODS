...
Playwright's own `includeHidden` and default `getByRole` engines, replays the
fleet round 069 page (`tests/fixtures/preview-palette/tower1-r069`) and its
amber repair, and replays two laptop pages whose uppercase-styled
"Show sold out" buttons Chromium named "SHOW SOLD OUT"
(`tests/fixtures/preview-inspection-laptop-round101.html`,
`tests/fixtures/preview-inspection-laptop-round107-site-1f5f2cf8.html`). Set
